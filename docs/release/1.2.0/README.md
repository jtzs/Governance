...
|---------|--------------|------------|--------------------|
| [1.2.0](https://jtzs.github.io/Governance/docs/release/1.2.0/) | 2026-05-27 | Current | Updated scenario based training to include interactive stories for participants; externalised training scenarios from documentation |
| [1.1.0](https://jtzs.github.io/Governance/docs/release/1.1.0/) | 2026-05-20 | Superseded | Inclusion of AI Governance framework as a core component |
| [1.0.1](https://jtzs.github.io/Governance/docs/release/1.0.1/) | 2026-05-14 | Superseded | Grammatical fixes, suggestions from Executive Director, updated risk management process, and added AI Governance framework |
| [1.0.0](https://jtzs.github.io/Governance/docs/release/1.0.0/) | 2025-08-12 | Superseded | Initial release |

## Closing remarks

A standard is only as effective as its implementation, and successful implementations can only happen in organisations with the close cooperation of leadership, staff, and volunteers. The goal of governance is not to penalise but to provide the organisation with direction and guidance on how best to protect its IT assets.
